...
android {
    namespace = "com.example.pieceauto"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.pieceauto"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation ("androidx.navigation:navigation-compose:2.8.3") // Check for the latest version
